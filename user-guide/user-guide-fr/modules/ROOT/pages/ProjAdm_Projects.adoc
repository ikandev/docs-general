...
. Cliquez sur l'icône _Administration des projets_ image:icons/icon_ProjectAdmin_13x13.png[,13,13]  dans le Menu Principal.
+
...
. Cliquez sur l'icône image:icons/icon_ProjectAdmin_13x13.png[,13,13]  _Administration des projets_ dans le Menu Principal.
